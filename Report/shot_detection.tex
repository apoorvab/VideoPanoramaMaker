...
The first method we implemented was based on color histogram-based shot boundary detection. Its basic idea is that color content does not change rapidly within but across shots.
